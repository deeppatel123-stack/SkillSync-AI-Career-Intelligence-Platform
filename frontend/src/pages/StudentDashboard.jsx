...
export default function StudentDashboard() {
  ...
  const aiFeatures = [
    ...
    },
    {
      ...
      desc: 'Receive an AI-powered career recommendation based on your skills, projects, and interests',
      color: 'icon-purple',
    },
    {
      to: '/ai/skill-gap',
      ...
      desc: 'Identify the important skills you are missing for your career path',
      color: 'icon-orange',
    },
    {
      ...
      icon: 'bi-signpost-2',
      title: 'Learning Hub',
      desc: 'Get a personalized learning roadmap based on your missing skills and career goals',
      color: 'icon-green',
    },
  ];
